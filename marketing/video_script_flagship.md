...
people. Edit anything that doesn't sound like something you'd actually say.

**Length target:** 8–12 minutes. Long enough to actually show the repair (that's what earns
trust and ranks), short enough that people finish it.
...
**0:00–0:30 — Hook**
Show the broken gear fragments in your hand first, before any explanation. "This little piece of
plastic is why your mirror won't fold — and dealerships want $1,000 to fix it." State plainly:
2007-2014 Tahoe, Suburban, Yukon, Denali, Escalade, Silverado, Sierra — this is the exact same
part across all of them.

**0:30–1:30 — Your story, short version**
Quick version of the origin story already on the site (`/about-history.html`): your wife's 2007
Escalade, the $1,000 dealer quote, tearing it apart to find a stripped plastic gear, redesigning
it in metal. Keep this tight — 60 seconds, not the full page. It's what makes people trust you're
not just another mail-in shop; you're the guy who figured out the actual problem.

**1:30–2:30 — How to tell what's actually wrong**
Two failure modes, straight from `/repairs.html`:
- Faint buzz, mirror doesn't move → gear (95% of cases)
...
pricing pages for anyone ready to start.

---

## B-roll / cutaway shot list

- Close-up: cracked gear fragments in your palm (use for thumbnail too)
- Close-up: new metal gear next to old plastic one, side by side
- Wide: full mirror assembly disassembled on the bench, parts laid out
...
## Follow-up videos (once the flagship is live — Phase 5 says short follow-ups)

- Per-vehicle removal quick-hits (Tahoe-specific, Escalade-specific, etc. — 2-3 min each,
  cheap to make by re-cutting flagship footage plus a vehicle-specific intro)
- "Gear vs. motor — how to tell which one broke" (pulls directly from `/repairs.html`)
- "How to pack your mirror for shipping" (once packing instructions are finalized on
