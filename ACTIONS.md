...
| M6 | IN PROGRESS | Phase 5 — Marketing engine | GBP claimed 2026-08-08. Video verification submitted 2026-08-15, under Google review. YouTube channel "GM Mirror Fix" (@gmmirrorfix) live since 2026-08-16, HeyGen AI-avatar explainer embedded on homepage hero. **Updated 2026-08-22**: swapped in an improved HeyGen render ("V4"), https://youtu.be/TesuXWvl4co — old version (S16Bfiitc7A) set to unlisted, not deleted. AI-use disclosure applied per YouTube policy on both. Flagship video script (`marketing/video_script_flagship.md`, full hands-on repair demo) still undone. | `marketing/`, BUSINESS_FACTS.md |
